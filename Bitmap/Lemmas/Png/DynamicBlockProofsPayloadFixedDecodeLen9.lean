...
lemma fixedLitLenHuffman_decode_readerAt_writeBits_len9_core
  ...
  have hrow7' :
    ...
    rw [show fixedLitLenRow7[bitsTot % 2 ^ 7]? =
        some (fixedLitLenRow7[bitsTot % 2 ^ 7]'hcode7) by
          exact Array.getElem?_eq_getElem hcode7] at hrow7''
  ...
  have hrow8' :
    ...
    rw [show fixedLitLenRow8[bitsTot % 2 ^ 8]? =
        some (fixedLitLenRow8[bitsTot % 2 ^ 8]'hcode8) by
          exact Array.getElem?_eq_getElem hcode8] at hrow8''
  ...
  have hrow9' :
    ...
    rw [show fixedLitLenRow9[bitsTot % 2 ^ 9]? =
        some (fixedLitLenRow9[bitsTot % 2 ^ 9]'hcode9) by
          exact Array.getElem?_eq_getElem hcode9] at hrow9''
